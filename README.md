...
Jan 24, 2024:
* No changes in macOS 14.3

Dec 12, 2023:
* Added macOS 14.2:  
  ```git difftool changeset/macOS14.1..changeset/macOS14.2```
* No changes in macOS 14.1.2

Nov 9, 2023:
* No changes in macOS 14.1.1
* Added macOS 14.1:  
  ```git difftool changeset/macOS14.0..changeset/macOS14.1```

Sep 26, 2023:
* Added macOS 14.0:  
  ```git difftool changeset/macOS13.5..changeset/macOS14.0```
* No changes in macOS 13.5.1
* No changes in macOS 13.5.2
  
Jul 24, 2023:
* Added macOS 13.5:  
  ```git difftool changeset/macOS13.4..changeset/macOS13.5```
